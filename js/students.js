  ...
  async function _doRenderProfile(studentData, txDocs, concessionData) {
    ...
    setContent(`
      ...
      ${(()=>{
        ...
        //
        // Reported live for ADM-2026-002: the profile showed "Monthly Fee 1,500" and
          ...
          if (isCurrent) {
            ...
            const curMonthCells = ACAD_MONTHS.map((short, i) => {
              ...
              const _concLabel   = _isConcMonth
                ...
                + `<div style="font-size:9px;color:var(--gold);font-weight:700;line-height:1.2">₹${fmtNum(_profileRateForMonth(short))}</div>`
                : '';
