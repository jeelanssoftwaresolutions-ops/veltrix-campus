...
async function runBulkPromotion() {
  ...
  try {
    ...
    for (const s of active) {
      ...
      // ══════════════════════════════════════════════════════════════════════
      const _alreadyLoggedBA = Array.isArray(s.promotionHistory) && s.promotionHistory.some(h =>
        h && h.source === 'annual'
    ...
    for (const s of toTerminate) {
      try {
        ...
        // not a concession, not a reconcile. Dinesh Bhat's transaction still carried
