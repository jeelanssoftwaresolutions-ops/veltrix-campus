    ...
    yrs.forEach(yy => {
      ...
      if (!yy.txList.length) {
        ...
        yy.txList.forEach(t => {
          ...
          doc.text(String(t.receipt).slice(0, 22), margin + 2, y);
          doc.text(money(t.amount), margin + 46, y);
          doc.text(String(t.months).slice(0, 34), margin + 74, y);
          doc.text(String(t.date), margin + 134, y);
          doc.text(String(t.mode).slice(0, 16), margin + 162, y);
          y += 4.6;
        });
        y += 3;
      }
