...
async function parseBulkAdmitFile(input) {
  ...
  try {
    ...
    rows.forEach((r, i) => {
      ...
      // the student is imported with a zero monthly fee. That is Inaaya Khan's exact
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    try {
      ...
      if (existingDoc) {
        ...
        // ══════════════════════════════════════════════════════════════════════
        // JSS-REF-VELTRIX-2026-005 — INAAYA'S ROOT CAUSE. Implausible class jump guard.
        //
        ...
        //
        // ADM-2026-002 is the live case: her own onboarding record says Nursery in
