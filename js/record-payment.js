...
//
// Reported live for ADM-2026-002: banner ₹20,400 / "12 unpaid months" while the grid
...
function showReceipt(tx) {
  ...
  // real payment. Mahesh Verma's 14,400 receipt is the one that surfaced it.
...
function printReceipt() {
  ...
  const txData = {
    ...
    feeHead        : (_tx && _tx.feeHead)       || val('fee head') || 'Academic Operational Fees',
