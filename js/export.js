...
async function exportFinancePDF() {
  ...
  try {
    ...
    // JSS-REF-002 ITEM 2 FIX: Cheque No. column added — blank for non-cheque payments.
    const body = txs.map(t=>[t.studentBlock||t.block||'—',t.receiptNumber,t.studentName,t.parentName||'—',t.contactNo||t.phone||'—',t.classSection,t.feeHead,'INR '+fmtNum(t.amountPaid),_finModeDisplay(t),_getChequeNoDisplay(t)||'—',fmtDate(t.date),t.paymentStatus]);
...
//     khaleel, Shaurya Sharma among them, some at 21,600 and above — and not one
...
//     found Dinesh Bhat's transaction still carrying 17,000 long after his
