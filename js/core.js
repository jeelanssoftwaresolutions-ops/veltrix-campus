...
/* ============================================================
   ...
   ============================================================ */
/* ============================================================
   FIRESTORE SECURITY RULES — MOVED.
   JSS-REF-VELTRIX-2026-005 ITEM 3.

   The authoritative ruleset now lives in  firestore.rules  at the repo root,
   as the ARC-018 + ARC-019 document with the ITEM 3 structural-lock fix applied.
   Keep editing it there: a commented-out copy cannot be diffed, reviewed or
   deployed, and this one had already drifted badly from what is actually
   published — it predates ARC-019 (principal-only excused waivers) and has no
   concessionFees block at all, though the live rules do cover that collection.
   Reading this block as if it were live is what produced a wrong
   "concessionFees will default-deny" claim; do not trust it for anything.

   Deployment is still manual: paste firestore.rules into
   Firebase Console → Firestore Database → Rules → Publish.

   The block below is the PRE-ITEM-3 ruleset, kept only as history so the
   change is reviewable. Do not deploy it.
   ─────────────────────────────────────────────────────────────────
   SCHEMA OVERVIEW
   ───────────────
