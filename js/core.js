...
// ══════════════════════════════════════════════════════════════════════════
// A VIEW IS ITS NAME *AND* ITS PARAMETERS. THE STACK ONLY REMEMBERED THE NAME.
//
// navigate() and pushNav() both pushed { view: currentView, params: {} } — the
// literal empty object, every time. So going forward from a parameterised view
// threw away the one thing that identified WHICH record you were looking at,
// and goBack() re-rendered it with nothing.
//
// Live case: open a student, tap Fee Card, tap back — renderStudentProfile({})
// has no id and paints "Student not found." on a student who exists. It was
// never about the Fee Card; every parameterised destination reached this way
// came back empty, and the deeper the trail the worse it read.
// ══════════════════════════════════════════════════════════════════════════
let currentParams   = {};    // Parameters the active view was rendered with
