...
function invalidateStudentCache() { _studentCache = null; _studentCacheTime = 0; window._promotionRows = null; /* BUG-N14 FIX: bust promotion cache so class edits reflect immediately */ window._cachedDynamicYears = null; /* ensure year list rebuilds after structural student changes */ }
...
// All major caches (_financeData, _allStudents, _allTerminated) get a timestamp
...
function _evictStaleCaches() {
  ...
  if (_isCacheStale('students'))   { window._allStudents = null;   delete _cacheWrittenAt.students; }
}
